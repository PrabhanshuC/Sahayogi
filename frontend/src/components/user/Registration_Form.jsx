...
export const Registration_Form = () =>
{
    const [form_data, set_form_data] = useState({
        username: "", password: "", email: "", name: "", about: "", github: "https://github.com/", website: ""
    });
            ...
            <article className="content">
                ...
                <form id="register" onSubmit={handle_register} className="content-body">
                    ...
                    <fieldset className="fieldset">
                        ...
                        <div className="row">
                            <input type="url" id="github" name="github" onChange={handle_change} value={ form_data.github } placeholder="https://github.com/your-profile" />
                        </div>
                        <div className="row">
